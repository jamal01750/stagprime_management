...
@section('title', 'Add Transaction | Company Own Project')
@section('heading', 'Add Transaction | Company Own Project')
...
<div 
    ...
    <div class="bg-white rounded shadow p-4 md:p-6">
        ...
        <form method="POST" action="{{ route('company.project.transaction.store') }}" class="space-y-4">
            @csrf
            <div>
