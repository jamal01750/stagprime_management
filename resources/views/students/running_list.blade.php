...
<div class="bg-white p-6 rounded shadow-md">
    ...
    <div class="bg-white rounded shadow p-4 md:p-6 mt-6 overflow-x-auto">
        <h2 class="text-xl font-semibold mb-4">Running Students List</h2>
        ...
        <thead class="bg-gray-100">
            <tr>
                ...
                <th class="border border-gray-300 px-3 py-2">Due Amount</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-3 py-2">{{ $student->due_amount }}</td>
                <td class="border px-3 py-2">{{ $student->payment_due_date }}</td>
                <td class="border px-3 py-2 text-center">
                    <select class="px-2 py-1 rounded">
                        <option class="bg-green-100 text-green-700">Running</option>
                        <option class="bg-red-100 text-red-700">Expired</option>
                    </select>
                    <a href="{{ route('student.active.status.update', $student->id) }}" 
