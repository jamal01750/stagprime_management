...
@section('title', 'Add Student | Student Registration')
@section('heading', 'Add Student | Student Registration')
    ...
    <div class="w-full flex flex-col space-y-6 md:space-y-8">
        ...
        <div class="bg-white rounded shadow p-4 md:p-6 flex flex-col md:flex-row items-start">
                ...
                <div class="w-4/5">
                    ...
                    <form method="POST" action="{{ route('student.registration.store') }}" enctype="multipart/form-data" class="space-y-3 md:space-y-4 w-full md:w-auto">
                        @csrf
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="student_name" class="mt-1 block w-full border-2 border-blue-600 focus:border-blue-700 focus:ring-blue-700 rounded bg-white text-gray-900 pl-[5px]" required>
                            @if ($errors->has('student_name'))
                                <span class="text-red-600 text-xs">{{ $errors->first('student_name') }}</span>
                            @endif
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <input type="number" name="total_fee" step="0.01" class="mt-1 block w-full rounded bg-white text-gray-900 border-2 border-blue-600 focus:border-blue-700 focus:ring-blue-700 pl-[5px]" required>
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Paid Amount</label>
                            <div class="flex space-x-2">
                                <input type="number" name="paid_amount" step="0.01" class="mt-1 block w-full rounded bg-white text-gray-900 border-2 border-blue-600 focus:border-blue-700 focus:ring-blue-700 pl-[5px]" required>
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Due Amount</label>
                            <div class="flex space-x-2">
                                <input type="number" name="due_amount" step="0.01" class="mt-1 block w-full rounded bg-white text-gray-900 border-2 border-blue-600 focus:border-blue-700 focus:ring-blue-700 pl-[5px]" required>
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Payment Due Date</label>
                            <input type="date" name="payment_due_date" class="mt-1 block w-full border-2 border-blue-600 focus:border-blue-700 focus:ring-blue-700 rounded bg-white text-gray-900">
                        </div>
                        <div>
