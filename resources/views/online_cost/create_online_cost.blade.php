...
@section('title', 'Add Cost | Office online Cost')
@section('heading', 'Add Cost | Office online Cost')
    ...
    <div class="w-full flex flex-col space-y-6 md:space-y-8">
        ...
        <div class="w-full flex flex-row">
            ...
            <div class="w-4/5 flex">
                <form method="post" action="{{ route('online.category.create') }}" class="block">
                    @csrf
        ...
        <div class="bg-white rounded shadow p-4 md:p-6 flex flex-col md:flex-row items-start">
                <div class="w-full flex flex-row">
                <div class="w-1/5 flex flex-col flex-shrink-0 pr-4">
                    <h2 class="text-lg md:text-xl font-semibold mb-2 md:mb-4">Set Online Expense</h2>
                </div>
                <div class="w-4/5">
                    <!-- The form starts here -->
                    <form method="POST" action="{{ route('online.cost.store') }}" class="space-y-3 md:space-y-4 w-full md:w-auto">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <select name="amount_type" class="mt-1 block rounded border-2 border-blue-600 bg-white text-gray-900">
