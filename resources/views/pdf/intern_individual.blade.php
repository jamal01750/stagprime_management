...
<head>
    <meta charset="UTF-8">
    <title>Student Details - {{ $student->internee_name }}</title>
    <style>
...
<body>
    ...
    <div class="image-container">
        @if($student->image)
            <img src="{{ public_path('storage/' . $student->image) }}" alt="Intern Image" width="120" height="120">
        @else
    ...
    <div class="section">
        ...
        <table class="info-table">
            <tr><td class="label">Name</td><td>{{ $student->internee_name }}</td></tr>
            <tr><td class="label">Intern Id</td><td>{{ $student->intern_id }}</td></tr>
    ...
    <div class="section">
        <h3>Payment Info</h3>
        <table class="info-table">
            <tr><td class="label">Total Contract</td><td>{{ number_format($student->pay_amount, 2) }}</td></tr>
            <tr><td class="label">Total Paid</td><td>{{ number_format($student->total_paid, 2) }}</td></tr>
            <tr><td class="label">Comment</td><td>{{ $student->description ?? '-' }}</td></tr>
        </table>
    </div>
